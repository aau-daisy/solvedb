...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	SIMILAR SIMPLE SKIP SMALLINT SNAPSHOT SOLVEMODEL SOLVESELECT SOME SQL_P STABLE STANDALONE_P
	START STATEMENT STATISTICS STDIN STDOUT STORAGE STRICT_P STRIP_P
	SUBJECTTO SUBSCRIPTION SUBSTRING SYMMETRIC SYSID SYSTEM_P
...
solver_param:			param_name 				{ $$ = makeDefElem($1, NULL, @1); }
