...
{     /* stand-alone LP/MIP solver */
      ...
      int ret;
      glp_long start;
/* Added by Laurynas for accurate time measuring */
...
err2:    {  xprintf("MathProg model processing error\n");
      ...
      /* Measure the solving time, by Laurynas */
      xprintf("Measuring of time started\n");
	...
	/* Output the solving time*/
	gettimeofday(&end_time, NULL);
	xprintf("Time used in solving: %.6f secs\n", time_diff(&end_time, &start_time));

/* MODIFIED BY Laurynas for the higher precision time output */
...
/* Added by Laurynas for time measuring */
